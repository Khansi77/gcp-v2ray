...
URI="vless://${VLESS_UUID}@vpn.googleapis.com:443?path=%2F%40ksnnet&security=tls&encryption=none&host=${CANONICAL_HOST}&type=ws&sni=vpn.googleapis.com#CHANNEL-404-VLESS-WS"
