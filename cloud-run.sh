...
# ==============================
URI="vless://${VLESS_UUID}@vpn.googleapis.com:443?path=%2F@ksnnet&security=tls&encryption=none&type=ws&host=${CANONICAL_HOST}&sni=${CANONICAL_HOST}#KS_NNET_CHANNEL"
