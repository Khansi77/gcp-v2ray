...
# ==============================
URI="vless://${VLESS_UUID}@vpn.googleapis.com:443?path=%2F%40nkka404&security=tls&encryption=none&type=ws&host=${CANONICAL_HOST}&sni=${CANONICAL_HOST}#KS_NNET_CHANNEL"
